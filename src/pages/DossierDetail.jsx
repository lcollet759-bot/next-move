        ...
        <div className="dd-body">
          ...
          {blocageCause && (
            <div className="dd-blocage">
              ...
              <button className="dd-blocage-btn" onClick={handleBlocageAction} onTouchEnd={(e) => { e.preventDefault(); handleBlocageAction() }}>{blocageCause.action}</button>
            </div>
          )}
            ...
            <div className="dd-section-body">
              ...
              <div className="dd-info-row">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  ...
                  {!isClos && (
                    <button className="dd-info-edit-btn" onClick={() => setShowEtatSheet(true)} onTouchEnd={(e) => { e.preventDefault(); setShowEtatSheet(true) }}>Changer</button>
                  )}
                </div>
              </div>
            </div>
        ...
        <div className="overlay" onClick={() => setShowConfirmClose(false)}>
          <div className="sheet" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <button className="btn btn-primary" style={{ flex: 2 }} onClick={handleClose} onTouchEnd={(e) => { e.preventDefault(); handleClose() }}>Confirmer</button>
            </div>
          </div>
        </div>
      )}
        ...
        <div className="overlay" onClick={() => setShowConfirmDel(false)}>
          <div className="sheet" onClick={e => e.stopPropagation()}>
            ...
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <button className="btn" style={{ flex: 2, background: '#C4623A', color: '#fff', borderRadius: 'var(--radius)', padding: '12px', fontWeight: 600, border: 'none', cursor: 'pointer' }} onClick={handleDelete} onTouchEnd={(e) => { e.preventDefault(); handleDelete() }}>
                Supprimer
              </button>
            </div>
          </div>
